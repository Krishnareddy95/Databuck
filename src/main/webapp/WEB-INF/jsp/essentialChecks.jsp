					...
					<div class="row">
							...
							<div class="row" style="padding-top: 20px;">
								<div class="col-md-12">
									...
									<div class="col-md-5 col-capture" style="padding-left: 120px">
										<div class="form-group form-md-line-input">
							...
							<div class="row" style="padding-top: 20px;">
								...
								<div class="col-md-12">
									...
									<div class="col-md-5 col-capture">
											<div class="form-group form-md-line-input">
												<label for="dGroupNullCheckThreashold">Microsegment Null Check</label>
											</div>
									</div>                                      
								</div>
								</div>
	...
	$("#createValidationCheck")
			.click(
					function() {
						...
						if(nameofEntityColumn == "" || nameofEntityColumn == null){
							nameofEntityColumn = "NA";
						}
						
						var recordAnomalyThreshold = 2.0;
				...
				$('#incrementalProblem').addClass('hidden');
						...
						$.ajax({
									url : './saveValidationEssentialChecksAjax',
									type : 'POST',
									...
									success : function(message) {
										...
										if (j_obj.hasOwnProperty('success')) {
											...
											'hidden');
											toastr
													.info('Essential Checks Created Successfully');
											setTimeout(function() {
												window.location.href = "createValidationAdvancedChecksTab?idApp=${idApp}&idData=${idData}";
