		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="portlet light bordered">
							...
							<tbody>
								...
								<c:forEach var="dashboardTableObj" items="${dashboardTable}">
									<tr>
										...
										<td><a onClick="validateHrefVulnerability(this)"  href="getMatchTablesData?appId=${dashboardTableObj.idApp}&source1=${dashboardTableObj.source1}&source2=${dashboardTableObj.source2}" class="nav-link">${dashboardTableObj.validationCheckName}</a></td>
					...
					<!-- Author: Pankaj, As per Dutta's suggestion this form is not needed currently.If needed in future it will be enhanced. -->
					
				<!--  	<form action="getMatchTablesData" method="GET" hidden="true">
						<div class="portlet-body">
