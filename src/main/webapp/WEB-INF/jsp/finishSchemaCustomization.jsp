						...
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5 col-capture" style="padding-bottom: 20px">
										<div class="form-group form-md-line-input">
							...
							<div class="row">
								...
								<div class="col-md-12" style="padding-top: 40px;">
									...
									<div class="col-md-5 col-capture">
										<div class="form-group form-md-line-input">
											<input type="text" class="form-control"
												id="validityThresholdId" name="validityThresholdId" value = "1.0"> <label
												for="validityThresholdText">Validity Threshold</label>
										</div>
									</div>
									...
									<div class="col-md-6 hidden" id="EveryDay" style="padding-left: 57px;">
							...
							<div class="row hidden" id="groupEqualitydiv">
								<div class="col-md-12">
									...
									<div class="col-md-5 col-capture" style="width: 36%;">
										<div class="form-group form-md-line-input">
											<input type="text" class="form-control"
							...
							<div class="row" style="padding-top: 50px;">
								<div class="col-md-12">
									<div class="col-md-1"></div>
										<div class="col-md-5"><b style="font-size: medium; font-weight: bold;">Data Cyclicality</b>
										</div>
										<div class="col-md-5">
											<div>
												<div class="form-group form-md-line-input">
							...
							<div id="noneid">
								...
								<div class="row" style="padding-left: 110px;">
									<div class="col-md-12">
										...
										<!--<div class="col-md-4 hidden" id="hodchecked"></div>-->
										</div>
									</div>
							...
							<div class="row" style="padding-top: 20px;">
								<div class="col-md-12">
									...
									<div class="col-md-5 col-capture">
											<div class="form-group form-md-line-input">
												<label for="applyRules">BadData Check</label>
											</div>
									</div>  
							...
							<div class="row" style="padding-top: 20px;">
								<div class="col-md-12">
										...
										<div class="form-group form-md-checkboxes">
											<div class="md-checkbox-list">
												<div class="md-checkbox">
													...
													<label for="defaultPatternCheck"> <span></span> <span
														class="check"></span> <span class="box"></span></label>
												</div>
											</div>
										</div>
									...
									<div class="col-md-5 col-capture">
											<div class="form-group form-md-line-input">
												<label for="applyRules">Default Pattern Check</label>
											</div>
									</div>                                    
								</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="col-md-5 col-capture">
											<div class="form-group form-md-line-input">
												<label for="applyRules">Max Length Check</label>
											</div>
									</div> 
								...
								<div class="col-md-12">
									...
									<div class="col-md-5 col-capture">
										<div class="form-group form-md-line-input">
											<label for="dGroupDateRuleCheckLabel">Microsegment DateRule Check</label>
										</div>
									</div> 
							...
							<div class="row" style="padding-top: 20px;">
								<div class="col-md-12">
										...
										<div class="form-group form-md-checkboxes">
											<div class="md-checkbox-list">
												<div class="md-checkbox">
													...
													<label for="dGroupDataDriftCheck"> <span></span> <span
														class="check"></span> <span class="box"></span></label>
												</div>
											</div>
										</div>
									...
									<div class="col-md-5 col-capture" >
											<div class="form-group form-md-line-input">
												<label for="dGroupDataDriftCheckLabel">MicroSegment Based DataDrift</label>
											</div>
									</div>
								</div>
							</div>
							
							<div class="row" style="padding-top: 15px;padding-left: 119px;">
									<div class="col-md-5 col-capture hidden">
										<div class="form-group form-md-line-input">
							...
							<div class="form-actions noborder">
								<button type="button" id="eCheckNext"
									class="btn blue btn-primary center-block">Next</button>
							</div>
							</div> -->
							...
							<div id="content_advanced_checks" class="advancedChecks">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-5 col-capture">
											<div class="form-group form-md-line-input">
												<!-- <input type="text" class="form-control" id="numericalStatsText" name="numericalStatsText">
												<label for="numericalStatsText">Numerical field stats and comparison</label>-->
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-5 col-capture">
											<div class="form-group form-md-line-input">
												<!--  <input type="text" class="form-control"placeholder="Number of Rows" id="numberofRows" name="numberofRows"> -->
												<input type='hidden' id="applyRulesEnabled" value="${applyRulesEnabled}" />
...
<script>
	function loadThresholdOptions(sThresholdOptions) {
		var aThresholdOptions = JSON.parse(sThresholdOptions), oSelectDomObj = $('#thresholds_apply_option')[0];
		
		UIManager.fillSelect(oSelectDomObj,aThresholdOptions);
	...
	$(document).ready(function() {
	    ...
	    if($('#applyRulesEnabled').val()=='Y'){
	        $('#applyRules').prop('checked', true);
	    }
		...
		var sThresholdOptions = '${ThresholdOptions}';				
		initializeJwfSpaInfra();       // Load JWF framework module on this page
		loadThresholdOptions(sThresholdOptions);
