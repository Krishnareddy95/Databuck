				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						...
						<div class="caption font-red-sunglo">
							<span class="caption-subject bold ">Matching Validation
								Checks Dashboard (<a onClick="validateHrefVulnerability(this)"  href="downloadCsv?tableName=dm_dashboard">Download
									csv</a>)
							</span>
						</div>
					</div>
						...
						<table
							...
							<thead>
								<tr>
									...
									<th>Source2 Name</th>
									<th>Source1 Count</th>
									<th>Source1 Only Records</th>
									<th>Source2 Count</th>
									<th>Source2 Only Records</th>
									<th>Unmatched Records</th>
									<th>Source1 Status</th>
									<th>Source2 Status</th>
							...
							<tbody>
								...
								<c:forEach var="dashboardTableObj" items="${dashboardTable}">
									<tr>
										...
										<td><a onClick="validateHrefVulnerability(this)"  href="getRollDataMatchTablesData?appId=${dashboardTableObj.idApp}&source1=${dashboardTableObj.source1}&source2=${dashboardTableObj.source2}" class="nav-link">${dashboardTableObj.validationCheckName}</a></td>
									 ...
									 List<KeyMeasurementMatchingDashboard> dataQualityMaster = (List)request.getAttribute("dashboardTable");
										...
										<td>${dashboardTableObj.unmatchedRecords}</td>
									...
									<%-- 	<td>${dashboardTableObj.unmatchedRecords }</td> --%>
									<%-- <td><%=df.format(Double.parseDouble(unmatchRec)) %></td> --%>
										<td><c:if
					...
					<form action="getRollDataMatchTablesData" method="GET">
						<div class="portlet-body">
							<input type="hidden" id="tourl" value="getRollDataMatchTablesData">
							<input type="hidden" id="source1" name="source1" >
							<input type="hidden" id="source2" name="source2" >
							<div class="row">
...
$('#myselect').on('change', function() {
				var no_error = 1;
				var app_id = $("#myselect").val();
				console.log("app_id:"+app_id);
				
				var postUrl = "getSourceTableDetails?appId="+app_id;
				...
				$.ajax({
	                ...
	                success: function(message1) {
	                    ...
	                    if (j_obj1.hasOwnProperty('success')) {
	                    	var source1 = j_obj1.source1;
	                    	var source2 = j_obj1.source2;
	                    	...
	                    	$('#source1').val(source1);
							$('#source2').val(source2);
							console.log("*source1:"+$('#source1').val());
			             	console.log("*source2:"+$('#source2').val());
