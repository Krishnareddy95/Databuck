...
<html>
  <head>
    ...
    <link href="./assets/global/plugins/apis1.css" media="screen" rel="stylesheet" />
    <link href="./assets/global/plugins/font-awesome.min.css" media="screen" rel="stylesheet" />

      <script src="./assets/global/plugins/moment.min.js"></script>
      <script src="./assets/global/plugins/moment-timezone-with-data.js"></script>
      <script src="./assets/global/plugins/jstz.js"></script>
      <script src="./assets/global/plugins/localtimes.js"></script>
  ...
  <div class="context primary-text-color">
   <h2> Oops! Something went wrong!<br>
    Please try again in some time.</h2>
  </div> 
  <hr>
