					...
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption font-red-sunglo">
								<span class="caption-subject bold ">DATA MATCHING GROUP TABLE FOR : ${appName}</span>
							</div>
						</div>
							...
							<div class="portlet-body">
								...
								while (sqlRowSet.next()) {
									...
									for (int k = 1; k <= sqlRowSet.getMetaData().getColumnCount(); k++) {
										if (sqlRowSet.getMetaData().getColumnTypeName(k).equalsIgnoreCase("double")
												|| sqlRowSet.getMetaData().getColumnTypeName(k).equalsIgnoreCase("decimal")
												|| sqlRowSet.getMetaData().getColumnTypeName(k).equalsIgnoreCase("float")) {
											//System.out.println("rs.getString(i):" + rs2.getString(i));
											out.println("<td>" + numberFormat.format(sqlRowSet.getDouble(k)) + "</td>");
