<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                    ...
                    <div class="portlet light bordered init">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold "> Edit Dashboard View </span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4 col-capture">
                                        <div class="form-group form-md-line-input">
                                            <div class="row">
                                                <input type="text" value="${idruleMap}" id="idruleMapId" hidden>
                                                <div class="col-md-12 col-capture">
                                                    <div class="form-group form-md-line-input">
                                                        <input type="text" class="form-control catch-error"
                                                            id="viewNameId" value="${viewName}"> <label
                                                            for="viewNameId">View Name*</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-capture" style="padding-top: 20px;">
                                                    <div style="padding-bottom: 10px;">Selected rules from
                                                        templates:</div>
                                                    <div style="height: 200px; overflow-y: scroll;" id="divRunTable">
                                ...
                                <div class="form-actions noborder align-center">
                                    <button type="submit" id="updateRuleBtnId" class="btn blue">Submit</button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function getIdAppList(idAppVal) {
        	//get ActualwebBasedUrl
        ...
        $(document).ready(function () {
            $.ajax({
                type: 'GET',
                url: 'rulesByRuleId',
                data: { idruleMap: '${idruleMap}' },
                success: function (response) {
                    var idDataList = '${idData}';
                    var idDatas = JSON.parse(idDataList);
                    var lsName = '${lsName}'
                    $("#dataTemplateId").val(idDatas[0] + "_" + lsName);
                    var idListColrules = '${idListColrules}';
                    var idListRules = JSON.parse(idListColrules);
                    var idListApps = '${listIdApps}';
                    var idApps = JSON.parse(idListApps);
                    $(response).each(function (i, item) {
                        selectedRulelist.push(item);
                    });
                    $(idDatas).each(function (i, item) {
                        list.push(item);
                    });
                    $(idListRules).each(function (i, item) {
                        ruleIdList.push(item);
                    });
                    $(idApps).each(function (i, item) {
                        idAppList.push(item);
                    });
            ...
            $('#updateRuleBtnId').click(function (params) {
                var no_error = 1;
