"use strict";var Gauge=function(t,s){t&&t instanceof jQuery&&this.init(t,s)};Gauge.defaults={template:['<div class="b-gauge">','<svg class="b-gauge__paths b-gauge__block" version="1.2" xmlns="http://www.w3.org/2000/svg"></svg>','<div class="b-gauge__marks b-gauge__block"></div>','<div class="b-gauge__labels b-gauge__block"></div>',"</div>"].join(""),
		 values: {
             0 : '0',
             20: '2',
             40: '4',
